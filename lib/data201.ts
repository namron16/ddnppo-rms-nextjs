...
export const PERSONNEL_201: Personnel201[] = [
  {
    ...
    status: 'Active',
    firearmSerialNo: 'GL-2024-00412',
    pagIbigNo: '1234-5678-9012',
    philHealthNo: '09-123456789-0',
    tin: '123-456-789-000',
    payslipAccountNo: 'LBP-0012-3456-78',
    documents: [
  ...
  },
  {
    ...
    dateOfRetirement: '2040-09-01',
    status: 'Active',
    firearmSerialNo: 'GL-2022-00198',
    pagIbigNo: '2345-6789-0123',
    philHealthNo: '09-234567890-1',
    tin: '234-567-890-000',
    payslipAccountNo: 'LBP-0023-4567-89',
  ...
  },
  {
    ...
    avatarColor: '#8b5cf6',
    address: 'Tagum City, Davao del Norte',
    contactNo: '09201122334',
    dateOfRetirement: '2044-03-15',
    status: 'Active',
    firearmSerialNo: 'GL-2023-00307',
    pagIbigNo: '3456-7890-1234',
    philHealthNo: '09-345678901-2',
    tin: '345-678-901-000',
    payslipAccountNo: 'LBP-0034-5678-90',
    documents: blankChecklist().map((d, i) => ({
      ...d,
      id: makeId('jr', i + 1),
